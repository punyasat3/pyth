...
profile="aws configure set profile."+ str(Account_Name)+ ".role_arn arn:aws:iam::" +str(Account_Id) + ":role/s3_cross_account"
...
try:
    ...
    logging.info(str(Account_Name)+ " Account invalid. Please configure IAM roles Properly for this account "+str(Account_Id))
    print("")
    ...
    try:
        ...
        logging.info(" "+str(sys.argv[0])+" : "+str(Account_Id)+" : -:-:- : -:-:- : -:-:- : Credentials are valid for user .")
    except:
